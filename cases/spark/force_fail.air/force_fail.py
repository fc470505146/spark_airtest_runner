...
from gm_commands import gm_force_fail
...
def test_gm_force_fail_can_retry_level():
    ...
    snapshot(msg="GM fail flow can retry level")


test_gm_force_fail_can_retry_level()
